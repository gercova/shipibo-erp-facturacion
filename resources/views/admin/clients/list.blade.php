        ...
        <div class="page-header-content">
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    ...
                    <div class="small text-muted mt-1">Cat&aacute;logo preparado para boleta, factura y validaci&oacute;n tributaria b&aacute;sica.</div>
                </div>
                <div class="col-auto">
                    <button class="dt-button create-new btn btn-success waves-effect waves-light btn-create-client mb-3" tabindex="0">
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table table-hover table-sm align-middle">
                            <thead>
                                ...
                                <tr>
                                    <th>
                                        <input type="text" id="name-filter" class="form-control form-control-sm" placeholder="Buscar cliente">
                                    </th>
                                    <th>
