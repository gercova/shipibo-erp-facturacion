    ...
    <div class="card shadow-sm mb-4 billing-report-card">
        ...
        <div class="card-body">
            <div class="billing-report-panel rounded-4 p-3 mb-4">
                ...
                <div class="row g-3 billing-report-filters mt-0">
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <input type="text" class="form-control" id="filter_series" placeholder="F001-00000025">
                    </div>
                    <div class="col-md-6 col-xl-3">
            ...
            <div class="table-responsive">
                <table id="salesRegisterTable" class="table table-striped table-center table-nowrap mb-0 report-table">
...
@section('scripts')
    @php
        ...
        $dataRoute = route('report.billings.sales_register.data');
        $pdfRoute = route('report.billings.sales_register.pdf');
        $excelRoute = route('report.billings.sales_register.excel');
        $datatableColumns = [
