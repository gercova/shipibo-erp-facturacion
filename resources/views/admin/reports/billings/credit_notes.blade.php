    ...
    <div class="card shadow-sm mb-4 billing-report-card">
        ...
        <div class="card-body">
            <div class="billing-report-panel rounded-4 p-3 mb-4">
                ...
                <div class="row g-3 billing-report-filters mt-0">
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <input type="text" class="form-control" id="filter_series" placeholder="BN01-00000010">
                    </div>
                    <div class="col-md-6 col-xl-3">
            ...
            <div class="report-summary-grid">
                <div class="report-summary-item"><small>Notas</small><strong id="summary_count">0</strong></div>
                <div class="report-summary-item"><small>Base</small><strong id="summary_gravada">{{ $signo }} 0.00</strong></div>
            ...
            <div class="table-responsive">
                <table id="creditNotesTable" class="table table-striped table-center table-nowrap mb-0 report-table">
                    <thead class="table-secondary">
                        <tr>
                            <th class="text-center">Fecha</th>
                            <th class="text-center">Nota</th>
                            <th>Cliente</th>
                            <th class="text-center">CPE relacionado</th>
                            <th>Motivo</th>
...
@section('scripts')
    @php
        $tableId = '#creditNotesTable';
        $dataRoute = route('report.billings.credit_notes.data');
        $pdfRoute = route('report.billings.credit_notes.pdf');
        $excelRoute = route('report.billings.credit_notes.excel');
        $datatableColumns = [
            ...
            ['data' => 'cpe_relacionado', 'name' => 'cpe_relacionado', 'className' => 'text-center', 'orderable' => false, 'searchable' => false],
            ['data' => 'motivo_credito', 'name' => 'credit_note_types.descripcion'],
