            ...
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    <h1 class="page-header-title">
                        ...
                        Gesti&oacute;n de Categor&iacute;as
                    </h1>
                </div>
                <div class="col-auto">
                    <button class="dt-button create-new btn btn-success waves-effect waves-light btn-create-category mb-3" tabindex="0">
                        <i class="ri-add-circle-line align-middle"></i>
                        <span class="d-none d-sm-inline">Agregar categor&iacute;a</span>
                    </button>
                </div>
            </div>
        </div>
...
@section('scripts')
    @include('admin.categories.js-datatable')
    @include('admin.categories.js-register')
    @include('admin.categories.js-store')
@endsection