            ...
            <div class="row align-items-center justify-content-between pt-3">
                <div class="col-auto mb-3">
                    <h1 class="page-header-title">
                        ...
                        Gesti&oacute;n de M&eacute;todos de Pago
                    </h1>
                </div>
                <div class="col-auto">
                    <button class="dt-button create-new btn btn-success waves-effect waves-light btn-create mb-3" tabindex="0">
                        ...
                        <span class="d-none d-sm-inline">Agregar m&eacute;todo de Pago</span>
                    </button>
                </div>
            </div>
        </div>
...
<div class="container-xl px-4 mt-4">
    ...
    @include('admin.paymodes.modals')
</div>

@endsection

@section('scripts')
    @include('admin.paymodes.js-datatable')
    @include('admin.paymodes.js-store')
@endsection