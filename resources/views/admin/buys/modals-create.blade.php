            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 mb-3 {{ request()->is('create-sale-note') ? 'd-none' : '' }}">
                        <label for="idalmacen">Almac&eacute;n</label>
                    ...
                    <div id="wrapper-product" class="col-12 mb-3 d-none">
                        ...
                        <small class="d-block text-muted mb-1">Se mostrar&aacute;n solo los productos disponibles en el almac&eacute;n seleccionado.</small>
