...
<body>
    <table class="header">
        <tr>
            ...
            <td class="data-ruc">
                <div class="name">COMPRA</div>
                <div class="number">{{ $buy->serie . '-' . $buy->correlativo }}</div>
            </td>
        </tr>
    </table>
    ...
    <table id="encabezado" style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
        <tr>
            ...
            <td style="width: 70%;">: {{ $provider->nombres }}</td>
        </tr>
        <tr>
