...
<body>
        ...
        <thead>
            <tr>
                <th
                    ...
                    #</th>
                <th
                    style="background-color: #f0f0f0; padding: 8px; text-align: center; border: 0.05px solid #ccc;">
                    DESCRIPCIÓN</th>
                <th
                ...
                <th style="background-color: #f0f0f0; padding: 8px; text-align: center; border: 0.05px solid #ccc; width: 14%;">
                    P.UNIT.</th>
        ...
        <tbody>
            @foreach ($detail as $i => $item)
                <tr>
                    ...
                    <td style="border: 0.05px solid #ccc; padding: 8px; text-align: center;">{{ intval($item["cantidad"]) }}</td>
                    <td style="border: 0.05px solid #ccc; padding: 8px; text-align: center;">{{ $item["unidad"] }}</td>
                    <td style="border: 0.05px solid #ccc; padding: 8px; text-align: center;">{{ number_format($item["precio_unitario"], 2, ".", "") }}</td>
                    <td style="border: 0.05px solid #ccc; padding: 8px; text-align: center;">{{ number_format($item["precio_total"], 2, ".", "") }}</td>
                </tr>
                @endforeach
        </tbody>
        </tbody>
    ...
    <div class="price-text" style="border: 1px solid #ccc; border-radius: 5px; padding: 8px; margin-bottom: 15px; display: flex; justify-content: space-between; text-align: center;">
        ...
        <tr>
            ...
            <td class="all-pay" style="width: 40%; border-left: 1px solid #ccc;">
                <div class="item">
                    ...
                    <div class="right">{{ number_format(($factura->subtotal), 2, '.', '') }}</div>
                </div>
                <div class="item">
